  ...
  return (
    <div className="relative min-h-screen ">
      ...
      <form
        ...
        className="w-full sm:w-10/12 md:w-8/12 lg:w-4/12 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-6 sm:p-8 md:p-12 bg-black text-white rounded-lg bg-opacity-80 "
      >
